...
public class DiagnosticData implements IDiagnostic{
    ...
    public String receive()
    {
        ...
        if (getDiagnosticMessageResult() == null || "".equals(getDiagnosticMessageResult()))
        {
        ...
        {
            message = getDiagnosticMessageResult();
            setDiagnosticMessageResult("");
        }
