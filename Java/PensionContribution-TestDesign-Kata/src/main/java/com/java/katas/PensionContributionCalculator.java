...
public class PensionContributionCalculator {
    ...
    public static BigDecimal calculatePensionContribution(BigDecimal annualSalary, int tenureYears, SeniorityLevel seniority, SalaryContributionPercentages percentages) {
        // BUG - fixed: Should throw an IllegalArgumentException if annualSalary is zero or below
        ...
        // BUG - fixed: Should be a long tenure bonus for 15 years or more
        if (tenureYears >= 15) {
        ...
        // BUG - fixed: one of the seniority bonuses is wrong - look in the relevant classes to find it
        ...
        // BUG - fixed: should divide by 100 (not 10) to get a percentage of annual salary
        return annualSalary
